...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, depth, misc, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, radii, depth, misc

    @staticmethod
    def backward(ctx, grad_out_color, grad_radii, grad_depth, grad_misc):
        ...
        grads = (
            ...
            grad_cov3Ds_precomp,
            grad_view.sum(0),
            grad_proj.sum(0), # Some grad may should be removed, so we do not sum them in the CUDA kernel
            None,
        )
